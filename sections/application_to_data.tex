...
The continuum of each of these templates is linearly interpolated around the emission lines, and the excess flux is attributed to the corresponding spectral lines. 
...
To overcome this difficulty, we use the Balmer decrements of 10,000K SDDS galaxies from \citet{Groves2012a}: H$\alpha/$H$\beta = 2.86$ and H$\gamma/$H$\delta = 1.81$.
...
The relative amplitudes and the effective widths of the lines can be seen in Table \ref{tab:speclines}.
\note{Is there anything else I should say about the results?}
...
\begin{figure*}
    ...
    \caption{\note{Write this caption. Compare to Figure \ref{fig:N8_trained}.}}
    \label{fig:speclines}
\end{figure*}
