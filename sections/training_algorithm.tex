...
This is analogous to the reconstruction of higher resolution HST images using the Drizzle technique \citep{Fruchter2002} and the reconstruction of higher resolution SED's using differential chromatic refraction (DCR; \citealt{Lee2019}).
